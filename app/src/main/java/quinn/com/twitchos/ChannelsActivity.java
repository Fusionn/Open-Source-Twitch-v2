...
public class ChannelsActivity extends AppCompatActivity {
    ...
    ProgressBar p;
    TextView t;
    List<ChannelList> streamers = new ArrayList<>();
    String game;
    ...
    protected void onCreate(Bundle savedInstance) {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                switch (position) {
                    case 1:
                        ...
                        ChannelsActivity.this.startActivity(following);
                        break;
                    case 2:
                        Intent games = new Intent(ChannelsActivity.this, MainActivity.class);
                        ChannelsActivity.this.startActivity(games);
                        break;
                    case 3:
                        //Intent channels = new Intent();
                        //ChannelsActivity.this.startActivity(channels);
                        break;
                    case 4:
                        Intent videos = new Intent();
                        ChannelsActivity.this.startActivity(videos);
                        break;
                }
            }
        });
        ...
        if(checkNetworkState(this)) {
            ...
            new GetStreamers().execute("https://api.twitch.tv/kraken/streams?limit=100");
        } else {
        ...
        lv.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        final String un = streamers.get(position).two.toLowerCase();
                        Thread t  = new Thread(
                                new Runnable() {
                                    @Override
                                    public void run() {
                                        try {
                                            ...
                                            Intent i = new Intent(ChannelsActivity.this, StreamViewActivity.class);
                                            i.putExtra("streamLink", fUrl);
                                            ChannelsActivity.this.startActivity(i);
                                        } catch(Exception ex) {
        ...
        protected String doInBackground(String... api_url) {
            try {
                ...
                for(int i = 0, n = streamsLive.length(); i < n; i++) {
                    ...
                    game = "Playing " + stream.getString("game");
                    ...
                    streamers.add(new ChannelList(picture,name,game,Integer.toString(viewers)));
                }
                final ChannelsAdapter sa = new ChannelsAdapter(ChannelsActivity.this, streamers);
